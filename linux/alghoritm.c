...
/*вычичлить длину, занимаемую всеми расположенными
...
/***
 * Один из интересных методов реализации генетичекого алгоритма
 * Это будет замена функции shorter_remnat()
 * Что если заставить ДНК как раз и выбирать заготовку с наименьшим обрезком?
 * Таким образом, все генерируемые комбинации всегда будут валидными
 */
